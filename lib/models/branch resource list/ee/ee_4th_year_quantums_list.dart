...
class EEFinalYearQuantumsList extends StatelessWidget {
  const EEFinalYearQuantumsList({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          ResourceCardModel(
            ...
            imgUrl: 'lib/assets/images/resource type bg/quantums.png',
            onTap: () {
              // goToQuantum('Power System & Protection',
          ...
          ResourceCardModel(
            ...
            onTap: () {
              // goToQuantum(
              //     'Power Quality & Facts', '1o7rXbkePcmwqSlip0adwnToUBGjdrKQr');
              launchUrls('1o7rXbkePcmwqSlip0adwnToUBGjdrKQr');
            },
          ),
        ],
