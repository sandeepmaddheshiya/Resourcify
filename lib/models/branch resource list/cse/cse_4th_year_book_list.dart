...
class CSEFinalYearBookList extends StatelessWidget {
  const CSEFinalYearBookList({super.key});
      ...
      body: ListView(
        ...
        children: [
          ResourceCardModel(
            ...
            onTap: () {
              // goToBook('Cloud Computing', '19kjKhCF0mvIuBF_GmSmWr8-Eq-UXES-P');

              launchUrls('19kjKhCF0mvIuBF_GmSmWr8-Eq-UXES-P');
            },
          ),
          ResourceCardModel(
            prefName: '',
            ...
            imgUrl: 'lib/assets/images/resource type bg/books.png',
            onTap: () {
              // goToBook('VFHS', '12JwZ1Rgbt-4ir4N_068qnh3KCoW3XOFU');
          ...
          ResourceCardModel(
            ...
            imgUrl: 'lib/assets/images/resource type bg/books.png',
            onTap: () {
              // goToBook('Artificial Intelligence',
              //     '12JwZ1Rgbt-4ir4N_068qnh3KCoW3XOFU');
              launchUrls('12JwZ1Rgbt-4ir4N_068qnh3KCoW3XOFU');
            },
          ),
        ],
